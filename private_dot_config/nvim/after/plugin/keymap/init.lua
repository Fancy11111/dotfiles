...
nnoremap("<leader>tc", ":tab split<CR>", {desc = "open current file in new buffer"})
nnoremap("<leader>tn", ":tabn<CR>", {desc = "goto next buffer"})
nnoremap("<leader>tb", ":tabp<CR>", {desc = "goto prev buffer"})
