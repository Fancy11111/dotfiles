...
vnoremap("J", ":m '>+1<CR>gv=gv", { desc = "Move marked lines down by one" })
vnoremap("K", ":m '<-2<CR>gv=gv", { desc = "Move marked lines up by one" })

nnoremap("Y", "yg$", { desc = "" })
nnoremap("n", "nzzzv", { desc = "Goto next search result and center line" })
nnoremap("N", "Nzzzv", { desc = "Goto last search result and center line" })
...
nnoremap("tc", ":tab split<CR>", {desc = "open current file in new buffer"})
nnoremap("tn", ":tabn<CR>", {desc = "goto next buffer"})
nnoremap("tb", ":tabp<CR>", {desc = "goto prev buffer"})
