    ...
    dependencies = {
      ...
      -- "github/copilot.vim",
      {
        ...
        opts = function()
          ...
          local mason_settings = require 'mason-core.package'
          mason_settings:get_aliases()
          -- mason_path
            ...
            plugins = {
              {
                ...
                location = '/home/daniel/.nvm/versions/node/v22.15.0/lib/node_modules/@vue/language-server',
                languages = { 'vue' },
              },
            },
          },
